<?php consultox_bunch_global_variable(); 
	...
	$layout = consultox_set( $settings, 'author_page_layout', 'full' );
	$sidebar = consultox_set( $settings, 'author_page_sidebar', 'default-sidebar' );
	$view = consultox_set( $settings, 'author_page_view', 'list' );
	...
	$bg = (consultox_set($meta, 'author_page_header_img'));
	$title = consultox_set($settings, 'author_page_header_title');
?>
<!--Page Title-->
